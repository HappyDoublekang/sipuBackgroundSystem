<template>
  <div class="brand-management">
    <div class="mgb15">
      <el-button :plain="true" type="success" @click="handlePopupForm('add')" :disabled="!brandManageRead">新建分类</el-button>
      <el-button :plain="true" type="warning" @click="handlePopupForm('edit')" :disabled="multipleSelection.length !== 1">修改分类</el-button>
      <el-button :plain="true" type="danger" @click="handleDelete" :disabled="multipleSelection.length === 0">删除分类</el-button>
    ...
    <div class="search-condition">
        ...
        <el-button :plain="true" type="primary" @click="search('searchForm')">搜索</el-button>
     </el-form>
  	</div>
    <el-table border :data="brandList" v-loading="loading" stripe @selection-change="handleSelectionChange" style="width: 100%">
      ...
      <el-table-column label="分类简称" align="center" :formatter="formatsShortName">
      </el-table-column>
      <el-table-column label="分类级别" :formatter="formatModifier" align="center">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    // 导出
    exportExcel() {
      this.$tool.exportExcel(this, 'brand/exportOrders')
    },
    // 新建或者编辑
    ...
    // 获取品牌列表
    queryList() {
      this.$http.post('category/list', this.postData).then(res => {
