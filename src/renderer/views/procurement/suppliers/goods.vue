<template>
  <div class="goodsFiles">
    ...
    <el-dialog custom-class="goods-Form" :title="formTitle" :visible.sync="formVisible" :before-close="handleClose">
      <suppliers-form ref="goodsFilesForm" :updated_form="form" :categoryOptions="categoryOptions" :formTitle="formTitle"></suppliers-form>
    </el-dialog>
  </div>
</template>
<script>
      ...
      this.$tool.common(this, 'category/list', {
        ...
        if (formName === 'add') {
          ...
          if (this.multipleSelection.length === 1) {
            ...
            this.$http.post('localhost:8081/erp/category/find', {
              'body': {
