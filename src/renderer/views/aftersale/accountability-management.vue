      ...
      <el-card class="box-card">
        <el-row type="flex" align="middle">
          <el-col :span="2">筛选条件:</el-col>
           <el-col :span="4">
            <el-select placeholder="来源类型"></el-select>
          </el-col>
          <el-col :span="4">
            <el-select placeholder="追责类型"></el-select>
          </el-col>
          <el-col :span="4">
            <el-select placeholder="责任人类型"></el-select>
          </el-col>
          <el-col :span="4">
            <el-select placeholder="撤销"></el-select>
          </el-col>
        </el-row>
        <br>
        <el-row type="flex" align="middle">
        ...
        <el-row type="flex" align="middle">
          ...
          <el-col :span="3">
            <el-input placeholder="追责编号"></el-input>
          </el-col>
          <el-col :span="3" :offset="1">
            <el-input placeholder="创建人"></el-input>
          </el-col>
          <el-col :span="3" :offset="1">
