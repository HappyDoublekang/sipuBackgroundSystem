    ...
    <div v-if="viewType == 'query'">
      <el-card class="box-card">
        ...
        <el-row type="flex" align="middle">
          ...
          <el-col :span="3">
            <el-input placeholder="关联单号"></el-input>
          </el-col>
          ...
          <el-col :span="24">
            <el-card>
              <el-form ref="form" :model="form" label-width="85px" label-position="left">
                <el-row type="flex" align="middle">
                  <el-col :span="12">
                    <el-form-item label="退货原因" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="12">
                    <el-form-item label="地址" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row type="flex" align="middle">
                  <el-col :span="12">
                    <el-row type="flex" align="middle" style="width:95%;">
                      <el-col :span="8">
                  ...
                  <el-col :span="12">
                    <el-form-item label="退货物流方式" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row type="flex" align="middle">
                  ...
                  <el-col :span="12">
                    <el-form-item label="退货物流单号" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
        ...
        <el-row type="flex" align="middle">
          <el-col :span="24">
            <el-table :data="tableData" style="width: 100%;" highlight-current-row >
              ...
              <el-table-column prop="name" label="品牌" show-overflow-tooltip></el-table-column>
              <el-table-column prop="shou" label="分类" show-overflow-tooltip width="110"></el-table-column>
              <el-table-column prop="phone" label="规格" show-overflow-tooltip width="110"></el-table-column>
              <el-table-column prop="fail" label="数量" show-overflow-tooltip width="240"></el-table-column>
              <el-table-column prop="sumprice" label="单价（元）" show-overflow-tooltip width="130"></el-table-column>
              <el-table-column prop="trueprice" label="金额（元）" show-overflow-tooltip width="130"></el-table-column>
              ...
              <el-form ref="form" :model="form" label-width="85px" label-position="left">
                <el-row type="flex" align="middle">
                  <el-col :span="12">
                    <el-row type="flex" align="middle" style="width:95%;">
                      <el-col :span="12">
                        <el-form-item label="退款金额" style="width:95%;">
                          <el-input></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12">
                        <el-form-item label="客户收款方式" style="width:95%;">
                          <el-select></el-select>
                        </el-form-item>
                      </el-col>
                    </el-row>
                  ...
                  <el-col :span="12">
                    <el-form-item label="收款账号" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row type="flex" align="middle">
                  <el-col :span="12">
                    <el-row type="flex" align="middle" style="width:95%;">
                      <el-col :span="12">
                        <el-form-item label="收款金额" style="width:95%;">
                          <el-input></el-input>
                        </el-form-item>
                      </el-col>
                      <el-col :span="12">
          ...
          <el-col :span="24">
            <el-card>
              <el-form ref="form" :model="form" label-width="85px" label-position="left">
                ...
                <el-row type="flex" align="middle">
                  <el-col :span="6">
                    <el-form-item label="单位名称" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
                    <el-form-item label="注册地址" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
                    <el-form-item label="注册电话" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
                    <el-form-item label="发票金额" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row type="flex" align="middle">
                  <el-col :span="6">
                    <el-form-item label="开户银行" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
                    <el-form-item label="税务登记代码" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
                    <el-form-item label="开户账户" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
                ...
                <el-row type="flex" align="middle">
                  <el-col :span="6">
                    <el-form-item label="受票人手机" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                  <el-col :span="6">
                    <el-form-item label="受票人姓名" style="width:95%;">
                      <el-input></el-input>
                    </el-form-item>
                  </el-col>
                </el-row>
                <el-row type="flex" align="middle">
                  <span style="width:85px;display:inline-block;font-size:12px;color:#606266;margin-bottom: 22px;">
                    收票人地址
                  </span>
                  <el-col :span="3">
                    <el-select style="margin-bottom: 22px;margin-right: 10px;"></el-select>
                  </el-col>
                  <el-col :span="3">
                    <el-select style="margin-bottom: 22px;margin-right: 10px;"></el-select>
                  </el-col>
                  ...
                  <el-col :span="15">
                    <el-input style="margin-bottom: 22px;"></el-input>
                  </el-col>
                </el-row>
                <el-row type="flex" align="middle">
                  <el-col :span="24">
