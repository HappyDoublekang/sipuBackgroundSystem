...
const routerPermissions = {
  ...
  outgoingManageRead: 'outgoing-management',
  warehousingManageRead: 'warehousing-management',
  inventoryManageRead: 'inventory-management',
  bulkPurchaseWarehousingRead: 'bulk-purchase-warehousing',
